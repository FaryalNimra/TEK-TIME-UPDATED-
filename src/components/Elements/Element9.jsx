  ...
  return (
    <div className="element9-container container">
      <div className="text-center">
        ...
        <h2 className="element9-heading">Features of Tektime</h2><br></br><br></br>
      ...
      <div className="row">
        <div className="col-md-6">
          <div className="element9-content">
            <img src="/Assests/Group 169.png" alt="Icon" className="img-fluidn1" />
            <h3 className="element9-subheading">Productive meetings</h3>
            <img src="/Assests/Line 13.png"alt="Icon" className="img-fluidn1" />
            <p className="element9-subparagraph">Maximize efficiency and collaboration in every meeting.</p>
          </div>
        </div>
        <div className="col-md-6">
          <div className="element9-content">
            <img src="/Assests/Group 171.png" alt="Icon" className="img-fluidn1" />
      ...
      <div className="row">
        <div className="col-md-6">
          <div className="element9-content">
            <img src="/Assests/streamline_arrow-roadmap.png" alt="Icon" className="img-fluidn1" />
        ...
        <div className="col-md-6">
          <div className="element9-content">
            <img src="/Assests/fluent-emoji-high-contrast_receipt.png"alt="Icon" className="img-fluidn1" />
