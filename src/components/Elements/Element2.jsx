      ...
      <div className="row">
        <div className="col-md-6 d-flex justify-content-center align-items-center">
          <div className="d-flex justify-content-center align-items-center mb-3">
            <img src="/Assests/report 1.png" alt="Image 1" className="img-fluid1 img-padding" />
          </div>
        </div>
        <div className="col-md-6 d-flex flex-column align-items-center">
          <div className="d-flex justify-content-center align-items-center mb-3">
            <img src="/Assests/Meeting 1.png" alt="Image 2" className="img-fluid img-padding" />
            <img src="/Assests/Option 1 1.png" alt="Image 3" className="img-fluid img-padding" />
          </div>
